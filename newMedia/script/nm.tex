...
\label{sec:org00aafa1}
\subsection*{Critical Theory}
\label{sec:orgaea5ae2}
...
\label{sec:org8e83fcf}

\subsection*{John Dewey's Aesthetics}
\label{sec:orgc1f66f8}
\subsubsection*{Pragmatism}
\label{sec:orgb60ed3e}
...
\label{sec:orgcf0f572}
\subsection*{Marshall McLuhan}
\label{sec:org66f9659}
\subsubsection*{Biographical Note}
\label{sec:org4e9e684}
\begin{itemize}
