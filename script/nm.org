...
with certainty`. 
1. Things that are known to be simply true, including true identity
...
2. Experiential knowledge -> this gave rise to a confidence in 
   ...
   middle ages.
3. Perception and apprehension of ones own actions or state 
   of being. If you are awake, you know yourself to be awake.
4. The class of things knowable through the human senses.
...
+ directly contravenes the way that humans perceive the sun
+ contradicted existing written accounts in the bible
...
summarized by the line *cogito, ergo sum* ("I think, therefor I am").

+ Went to to make the distinction between two diferent sources of knowledge:
  intuition and induction
+ also proved the existence of God (to his own satisfaction)
+ believed the ultimate source of knowledge to be reason
+ it was fairly widely aknowledged that much of Descartes' philosophical 
  work it tautological (it relies on itself to be true)
+ his most lasting contribution has been coordinate geometry
...
3. sensitive knowledge - "the particualr existence of finite beings without us"
...
```
Basically, Berkely believed that for any nonthinking being, *esse est percipi* 
...
1. analytic a priori propositions - "All squares have four sides"
2. synthetic a posteriori propositions - "The cat is on the mat"
